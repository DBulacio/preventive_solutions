    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarExample01">
            ...
            <ul class="navbar-redes navbar-nav text-white hide-on-mobile">
                ...
                <li class="menu">
                    <a tabindex="-1" class="nav-link redes" id="facebook" href="https://www.facebook.com/oxfordcollegeinstitute/" rel="nofollow" target="_blank">
                        <i class="fab fa-facebook"></i>
                    </a>
                </li>
                <li class="menu">
                    <a tabindex="-1" class="nav-link redes" id="twitter" href="https://twitter.com/oxfordteens/" rel="nofollow" target="_blank">
